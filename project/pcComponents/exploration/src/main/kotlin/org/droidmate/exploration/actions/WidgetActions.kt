...
fun Widget.swipeDown(stepSize: Int = 35): ExplorationAction = Swipe(Pair(this.visibleBounds.center.first, this.visibleBounds.center.second-this.visibleBounds.height/4), Pair(this.visibleBounds.center.first, this.visibleBounds.topY + this.visibleBounds.height), stepSize, true)
...
fun Widget.swipeRight(stepSize: Int = 35): ExplorationAction = Swipe(Pair(this.visibleBounds.center.first-this.visibleBounds.width/4, this.visibleBounds.center.second), Pair(this.visibleBounds.leftX + this.visibleBounds.width, this.visibleBounds.center.second), stepSize, true)
